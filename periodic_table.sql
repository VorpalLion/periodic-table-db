...
ALTER SEQUENCE public.types_types_id_seq OWNED BY public.types.type_id;
...
ALTER TABLE ONLY public.types ALTER COLUMN type_id SET DEFAULT nextval('public.types_types_id_seq'::regclass);
